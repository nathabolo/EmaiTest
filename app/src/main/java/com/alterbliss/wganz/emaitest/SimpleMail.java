package com.alterbliss.wganz.emaitest;
...
/**
 * Created by adminmini on 2018/04/05.
 */

public class SimpleMail {
    /**CHANGE ACCORDINGLY**/
    private static final String SMTP_HOST_NAME = "smtp.gmail.com"; //can be your host server smtp@yourdomain.com
    private static final String SMTP_AUTH_USER = "malizomamabolo@gmail.com"; //your login username/email
    private static final String SMTP_AUTH_PWD  = "33nathabolo23nm"; //password/secret
